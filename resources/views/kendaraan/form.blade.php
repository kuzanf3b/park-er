...
<div class="card" style="max-width:500px">
    ...
    <div class="card-body">
        <form method="POST" action="{{ isset($kendaraan) ? route('kendaraan.update', $kendaraan->id_kendaraan) : route('kendaraan.store') }}">
            @csrf
            @if(isset($kendaraan))
                @method('PUT')
            @endif
            ...
            <div class="form-group">
                ...
                <input type="text" name="plat_nomor" class="form-control" value="{{ old('plat_nomor', $kendaraan->plat_nomor ?? '') }}" required style="text-transform:uppercase">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="jenis_kendaraan" class="form-control" required>
                    ...
                    <option value="{{ $jenis }}" {{ old('jenis_kendaraan', $kendaraan->jenis_kendaraan ?? '') === $jenis ? 'selected' : '' }}>
                        {{ ucfirst($jenis) }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="pemilik" class="form-control" value="{{ old('pemilik', $kendaraan->pemilik ?? '') }}">
                </div>
            </div>
