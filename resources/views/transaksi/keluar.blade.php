...
@section('content')
    <div class="card" style="max-width:560px">
        ...
        <div class="card-body">
            ...
            <div style="background:var(--surface-2);padding:20px;border-radius:var(--radius);margin-bottom:24px">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
                    ...
                    <div>
                        ...
                        <div style="font-size:14px;font-weight:500">{{ ucfirst($transaksi->kendaraan->jenis_kendaraan) }}
                        </div>
                    </div>
                    <div>
            ...
            <!-- Preview Biaya -->
            <div
                style="background:#eff6ff;padding:20px;border-radius:var(--radius);margin-bottom:24px;border:1px solid #bfdbfe">
                <h4 style="font-size:14px;color:#1e40af;margin-bottom:12px"><i class="fas fa-calculator"></i> Preview Biaya
                </h4>
                ...
                @if ($preview['jam_denda'] > 0)
                    <div class="receipt-row" style="color:var(--danger)">
                        <span><i class="fas fa-exclamation-triangle"></i> Denda ({{ $preview['jam_denda'] }} jam ×
                            150%)</span>
