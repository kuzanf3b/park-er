                    ...
                    <div class="form-group">
                        ...
                        <select name="id_area" class="form-control" required id="areaParkir">
                            ...
                            @foreach ($areas as $area)
                                <option value="{{ $area->id_area }}" data-jenis="{{ $area->jenis_kendaraan }}"
                                    {{ old('id_area') == $area->id_area ? 'selected' : '' }} style="display:none">
                    ...
                    <select name="id_user" class="form-control" required>
                        ...
                        @foreach ($owners as $owner)
                            <option value="{{ $owner->id_user }}"
                                {{ (string) old('id_user') === (string) $owner->id_user ? 'selected' : '' }}>
