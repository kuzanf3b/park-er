...
<div class="card mb-6">
    ...
    <div class="card-body">
        <div class="grid-3">
            ...
            @endphp
            <div style="padding:16px;border:1px solid var(--border);border-radius:var(--radius);background:var(--surface-2)">
                <div class="flex justify-between items-center mb-2" style="margin-bottom:8px">
                    ...
                    <span class="badge badge-{{ $persen >= 90 ? 'danger' : ($persen >= 70 ? 'warning' : 'success') }}">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <span class="badge badge-success"><i class="fas fa-check" style="font-size:9px"></i> Keluar</span>
                        @endif
                    </td>
                    <td>
                        @if($t->biaya_total)
